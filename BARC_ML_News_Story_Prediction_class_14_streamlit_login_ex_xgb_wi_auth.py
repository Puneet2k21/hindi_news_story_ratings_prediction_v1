...
# Check if login_result is None before unpacking
...
if authentication_status:
    ...
    st.warning('Please enter your username and password') # Provide the login form again if authentication status is None
